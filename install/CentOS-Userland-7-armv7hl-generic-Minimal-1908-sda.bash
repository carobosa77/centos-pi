...
# Download the image from http://isoredirect.centos.org/altarch/7/isos/armhfp/CentOS-Userland-7-armv7hl-generic-Minimal-1908-sda.raw.xz, or search for an updated image at http://isoredirect.centos.org/altarch/7/isos/armhfp/
...
do_fstab() {
  cat << EOD | tr -s ' '
${TARGET_PARTITIONS_PREFIX}1 /boot/fw vfat defaults,noatime,nosuid,noexec,nodev 0 2
...
do_mount_source() {
  ...
  mount ${SOURCE_PARTITIONS_PREFIX}1 ${SOURCE_MOUNT}/boot/fw
}
